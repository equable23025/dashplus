	...
	for historycard in data_json :
		try:
			...
			if str(historycard['type']) == 'addMemberToCard' or str(historycard['type']) == 'removeMemberFromCard' or str(historycard['type']) == 'updateCustomFieldItem' :
				...
				demoDatabases2.execute("INSERT INTO myapp_card_effort_record  (\"action_card\", \"id_card\", \"custom_name\", \"current_value\", \"old_value\" ,\"timestamp_id\" ,\"username\" , \"board\")VALUES ('{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}')".format(r1,r2,r3,r4,r5,r6,r7,r8))
				conn2.commit()
		except KeyError as e:
			pass
		finally:
